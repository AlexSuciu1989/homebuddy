    ...
    <body>
        ...
        <div class="registerform">
            <form action="./php/registerSQL.php" method="POST" >
                ...
                <input type="password" placeholder="Password" id="password" name="password" class="loginInput" onchange="validatePassword()" required><br><br>

                <label>Confirm Password</label>
                <input type="password" placeholder="Confirm Password" id="confirm_password" class="loginInput" onkeyup = validatePassword();  required><br><br>

                <input type="submit" name="Submit" class="LoginButton" title="Update" value="Create new account"><br><br>
                <input type="button" value="Cancel" class="LoginButton" onclick="window.location.href='/alex/index.html';">
